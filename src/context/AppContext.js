...
// reducer to update the state based on an action
...
// create the context so components can import and use to get the state
export const AppContext = createContext();

// provider that wraps the components to give access to the state
